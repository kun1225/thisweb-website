...
export function HomeMagnet({ data }: { data: TypeHome['leadMagnet'] }) {
  ...
  return (
    <section className="bg-blue-5 px-edge-dynamic py-32 text-center">
      ...
      <div className="flex flex-col items-center justify-center gap-10 md:flex-row md:gap-edge">
        <div className="max-w-xl">
          {paragraph ? (
            <div className="text-pretty text-left prose-p:mb-1 prose-ol:mt-4 prose-ol:list-inside prose-ol:list-decimal">
