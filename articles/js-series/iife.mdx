---
title: "JavaScript 教學 觀念篇 4 - 立即執行函數 IIFE"
desc: "立即執行函數又稱 IIFE(Immediately Invoked Function Expression)，對於初學者來說，很容易把立即執行函數跟閉包搞混，也很多文章會將它們兩個混在一起說，會這樣是因為立即執行函數常常會和閉包結合起來使用。"
date: "2023-08-13"
---

立即執行函數又稱 IIFE(Immediately Invoked Function Expression)，對於初學者來說，很容易把立即執行函數跟閉包搞混，也很多文章會將它們兩個混在一起說，會這樣是因為立即執行函數常常會和閉包結合起來使用。

如果你還不知道閉包是甚麼，可以參考我寫的這篇文章
[JavaScript 教學 觀念篇 3 - 閉包 Closure](/)

那就讓我們來看看立即執行函數是什麼，以及他是怎麼跟閉包結合的吧！
