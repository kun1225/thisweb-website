...
desc: '在 ES6 中，JS 新增了創造物件的語法 - **類 class**，而在前面原型的文章中，你也可以發現原型鏈的寫法不太友善，於是才有了 class 的誕生。不過 class 的原理就是原型鏈，他只是為了讓我們更快速開發，以及銜接其它語言(因為其它語言大多有 class 這個用法)而有的語法。！'
date: '2023-08-07'
---

在 ES6 中，JS 新增了創造物件的語法 - **類 class**，而在前面原型的文章中，你也可以發現原型鏈的寫法不太友善，於是才有了 class 的誕生。

不過 class 的原理就是原型鏈，他只是為了讓我們更快速開發，以及銜接其它語言(因為其它語言大多有 class 這個用法)而有的語法。
...
_這裡如果不懂的話，建議先來看看<a href="https://thisweb.tech/js-prototype-inherit/" target="_blank" rel="noopener"> JS 原型鏈和繼承</a>_
