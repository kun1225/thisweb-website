---
title: "如何用 useEffect 串接 API？"
desc: "在 React 中，我們常常在 useEffect 裡串接 api 來獲取資料，這意味著我們會使用非同步函式來取得資料，但在 useEffect 使用非同步函式可能沒有你想像的簡單。"
date: "2023-09-06"
---
...
此篇筆記參考
  ...
  <a href="https://devtrium.com/posts/async-functions-useeffect" target="_blank" rel="noopener">How to use async functions in useEffect </a>
  <a href="https://www.robinwieruch.de/react-hooks-fetch-data/" target="_blank" rel="noopener">How to fetch data with React Hooks</a>
