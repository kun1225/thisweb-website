...
export const NEXT_POSTS_QUERY = groq`*[_type == "post"  && defined(slug) &&  publishedAt > $publishedAt][0]`;
export const PREV_POSTS_QUERY = groq`*[_type == "post"  && defined(slug) && publishedAt < $publishedAt][0]`;