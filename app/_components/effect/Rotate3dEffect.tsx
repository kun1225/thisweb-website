...
const Rotate3dEffect: React.FC<Rotate3dEffectProps> = ({
  ...
  return (
    ...
    >
      ...
      >
        <div className="col-[1/2] row-[1/2] group-hover:scale-105 transition duration-500">{children}</div>
        <div className="col-[1/2] row-[1/2] blur-lg opacity-20 group-hover:opacity-50 transition duration-500" style={{transform: 'translateZ(-150px)'}}>{children}</div>
      </motion.div>
    </div>
  );
};
